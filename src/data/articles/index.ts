...
import { meterToInch } from "./meterToInch";
import { meterToNmi } from "./meterToNmi";
import { meterToRod } from "./meterToRod";
import { meterToChain } from "./meterToChain";
import { meterToFurlong } from "./meterToFurlong";
import { meterToLeague } from "./meterToLeague";
import { meterToHand } from "./meterToHand";
...
import { kilometerToMillimeter } from "./kilometerToMillimeter";
import { kilometerToMicrometer } from "./kilometerToMicrometer";
import { kilometerToNanometer } from "./kilometerToNanometer";
import { kilometerToMile } from "./kilometerToMile";
import { kilometerToYard } from "./kilometerToYard";
...
import { henryToNanohenry } from "./henryToNanohenry";
import { millihenryToHenry } from "./millihenryToHenry";
import { millihenryToMicrohenry } from "./millihenryToMicrohenry";
import { millihenryToNanohenry } from "./millihenryToNanohenry";
import { microhenryToHenry } from "./microhenryToHenry";
import { microhenryToMillihenry } from "./microhenryToMillihenry";
import { microhenryToNanohenry } from "./microhenryToNanohenry";
import { nanohenryToHenry } from "./nanohenryToHenry";
import { nanohenryToMillihenry } from "./nanohenryToMillihenry";
import { nanohenryToMicrohenry } from "./nanohenryToMicrohenry";

import { becquerelToCurie } from "./becquerelToCurie";
import { becquerelToRutherford } from "./becquerelToRutherford";
import { becquerelToKilobecquerel } from "./becquerelToKilobecquerel";
import { becquerelToMegabecquerel } from "./becquerelToMegabecquerel";
import { curieToBecquerel } from "./curieToBecquerel";
import { curieToRutherford } from "./curieToRutherford";
import { curieToKilobecquerel } from "./curieToKilobecquerel";
import { curieToMegabecquerel } from "./curieToMegabecquerel";
import { rutherfordToBecquerel } from "./rutherfordToBecquerel";
import { rutherfordToCurie } from "./rutherfordToCurie";
import { rutherfordToKilobecquerel } from "./rutherfordToKilobecquerel";
import { rutherfordToMegabecquerel } from "./rutherfordToMegabecquerel";
import { kilobecquerelToBecquerel } from "./kilobecquerelToBecquerel";
import { kilobecquerelToCurie } from "./kilobecquerelToCurie";
import { kilobecquerelToRutherford } from "./kilobecquerelToRutherford";
import { kilobecquerelToMegabecquerel } from "./kilobecquerelToMegabecquerel";
import { megabecquerelToBecquerel } from "./megabecquerelToBecquerel";
import { megabecquerelToCurie } from "./megabecquerelToCurie";
import { megabecquerelToRutherford } from "./megabecquerelToRutherford";
import { megabecquerelToKilobecquerel } from "./megabecquerelToKilobecquerel";

import { faradToMillifarad } from "./faradToMillifarad";
import { faradToMicrofarad } from "./faradToMicrofarad";
import { faradToNanofarad } from "./faradToNanofarad";
import { faradToPicofarad } from "./faradToPicofarad";
import { millifaradToFarad } from "./millifaradToFarad";
import { millifaradToMicrofarad } from "./millifaradToMicrofarad";
import { millifaradToNanofarad } from "./millifaradToNanofarad";
import { millifaradToPicofarad } from "./millifaradToPicofarad";
import { microfaradToFarad } from "./microfaradToFarad";
import { microfaradToMillifarad } from "./microfaradToMillifarad";

import { gramToKilogram } from "./gramToKilogram";
import { gramToMilligram } from "./gramToMilligram";
import { gramToMicrogram } from "./gramToMicrogram";
import { gramToPound } from "./gramToPound";
import { gramToOunce } from "./gramToOunce";
import { gramToStone } from "./gramToStone";
import { gramToMetricTon } from "./gramToMetricTon";
...
import { squareMeterToSquareMillimeter } from "./squareMeterToSquareMillimeter";
import { squareMeterToSquareMile } from "./squareMeterToSquareMile";
...
import { literToCubicCentimeter } from "./literToCubicCentimeter";
import { literToCubicFoot } from "./literToCubicFoot";
import { literToCubicInch } from "./literToCubicInch";
import { literToGallonUs } from "./literToGallonUs";
import { literToGallonUk } from "./literToGallonUk";
...
import { celsiusToRomer } from "./celsiusToRomer";
...
import { secondToNanosecond } from "./secondToNanosecond";
import { secondToMinute } from "./secondToMinute";
import { secondToHour } from "./secondToHour";
import { secondToDay } from "./secondToDay";
import { secondToWeek } from "./secondToWeek";
...
import { meterPerSecondToKnot } from "./meterPerSecondToKnot";
import { meterPerSecondToMach } from "./meterPerSecondToMach";
import { meterPerSecondToSpeedOfLight } from "./meterPerSecondToSpeedOfLight";
import { meterPerSecondToFootPerSecond } from "./meterPerSecondToFootPerSecond";
import { kilometerPerHourToMeterPerSecond } from "./kilometerPerHourToMeterPerSecond";
...
import { wattToGigawatt } from "./wattToGigawatt";
import { wattToHorsepowerMechanical } from "./wattToHorsepowerMechanical";
import { wattToHorsepowerMetric } from "./wattToHorsepowerMetric";
import { wattToBtuPerHour } from "./wattToBtuPerHour";
import { wattToCaloriePerSecond } from "./wattToCaloriePerSecond";
...
export const customLengthArticles: Record<string, CustomArticleData> = {
  ...
  "meter-to-furlong": meterToFurlong,
  "meter-to-league": meterToLeague,
  "meter-to-hand": meterToHand,
  "meter-to-cubit": meterToCubit,

  "kilometer-to-meter": kilometerToMeter,
  "kilometer-to-centimeter": kilometerToCentimeter,
  "kilometer-to-millimeter": kilometerToMillimeter,
  "kilometer-to-micrometer": kilometerToMicrometer,
  "kilometer-to-nanometer": kilometerToNanometer,
  "kilometer-to-mile": kilometerToMile,
  "kilometer-to-yard": kilometerToYard,
  ...
  "henry-to-nanohenry": henryToNanohenry,
  "millihenry-to-henry": millihenryToHenry,
  "millihenry-to-microhenry": millihenryToMicrohenry,
  "millihenry-to-nanohenry": millihenryToNanohenry,
  "microhenry-to-henry": microhenryToHenry,
  "microhenry-to-millihenry": microhenryToMillihenry,
  "microhenry-to-nanohenry": microhenryToNanohenry,
  "nanohenry-to-henry": nanohenryToHenry,
  "nanohenry-to-millihenry": nanohenryToMillihenry,
  "nanohenry-to-microhenry": nanohenryToMicrohenry,

  "becquerel-to-curie": becquerelToCurie,
  "becquerel-to-rutherford": becquerelToRutherford,
  "becquerel-to-kilobecquerel": becquerelToKilobecquerel,
  "becquerel-to-megabecquerel": becquerelToMegabecquerel,
  "curie-to-becquerel": curieToBecquerel,
  "curie-to-rutherford": curieToRutherford,
  "curie-to-kilobecquerel": curieToKilobecquerel,
  "curie-to-megabecquerel": curieToMegabecquerel,
  "rutherford-to-becquerel": rutherfordToBecquerel,
  "rutherford-to-curie": rutherfordToCurie,
  "rutherford-to-kilobecquerel": rutherfordToKilobecquerel,
  "rutherford-to-megabecquerel": rutherfordToMegabecquerel,
  "kilobecquerel-to-becquerel": kilobecquerelToBecquerel,
  "kilobecquerel-to-curie": kilobecquerelToCurie,
  "kilobecquerel-to-rutherford": kilobecquerelToRutherford,
  "kilobecquerel-to-megabecquerel": kilobecquerelToMegabecquerel,
  "megabecquerel-to-becquerel": megabecquerelToBecquerel,
  "megabecquerel-to-curie": megabecquerelToCurie,
  "megabecquerel-to-rutherford": megabecquerelToRutherford,
  "megabecquerel-to-kilobecquerel": megabecquerelToKilobecquerel,

  "farad-to-millifarad": faradToMillifarad,
  "farad-to-microfarad": faradToMicrofarad,
  "farad-to-nanofarad": faradToNanofarad,
  "farad-to-picofarad": faradToPicofarad,
  "millifarad-to-farad": millifaradToFarad,
  "millifarad-to-microfarad": millifaradToMicrofarad,
  "millifarad-to-nanofarad": millifaradToNanofarad,
  "millifarad-to-picofarad": millifaradToPicofarad,
  "microfarad-to-farad": microfaradToFarad,
  "microfarad-to-millifarad": microfaradToMillifarad,

  "gram-to-kilogram": gramToKilogram,
  "gram-to-milligram": gramToMilligram,
  "gram-to-microgram": gramToMicrogram,
  "gram-to-pound": gramToPound,
  "gram-to-ounce": gramToOunce,
  "gram-to-stone": gramToStone,
  "gram-to-metric-ton": gramToMetricTon,
  ...
  "square-meter-to-square-millimeter": squareMeterToSquareMillimeter,
  "square-meter-to-square-mile": squareMeterToSquareMile,
  "square-meter-to-square-yard": squareMeterToSquareYard,
  "square-meter-to-square-foot": squareMeterToSquareFoot,
  "square-meter-to-square-inch": squareMeterToSquareInch,
  ...
  "liter-to-cubic-centimeter": literToCubicCentimeter,
  "liter-to-cubic-foot": literToCubicFoot,
  "liter-to-cubic-inch": literToCubicInch,
  "liter-to-gallon-us": literToGallonUs,
  "liter-to-gallon-uk": literToGallonUk,
  ...
  "celsius-to-reaumur": celsiusToReaumur,
  "celsius-to-newton": celsiusToNewton,
  "celsius-to-romer": celsiusToRomer,
  "celsius-to-delisle": celsiusToDelisle,
  ...
  "second-to-hour": secondToHour,
  "second-to-day": secondToDay,
  "second-to-week": secondToWeek,
  ...
  "meter-per-second-to-knot": meterPerSecondToKnot,
  "meter-per-second-to-mach": meterPerSecondToMach,
  "meter-per-second-to-speed-of-light": meterPerSecondToSpeedOfLight,
  "meter-per-second-to-foot-per-second": meterPerSecondToFootPerSecond,
  ...
  "watt-to-gigawatt": wattToGigawatt,
  "watt-to-horsepower-mechanical": wattToHorsepowerMechanical,
  "watt-to-horsepower-metric": wattToHorsepowerMetric,
  "watt-to-btu-per-hour": wattToBtuPerHour,
